...
from rooms.models import Result, Room, RoundState, Subject, Round, Item
...
def _act(room, text, value, seq=1):
    ...
    return Result.objects.create(round=rnd, subject=subject, item=item, chosen_value=value)
